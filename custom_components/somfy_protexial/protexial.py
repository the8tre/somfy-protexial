            ...
            if response.status == 200:
                if (
                    ...
                    if (
                        ...
                        error_code == SomfyError.SESSION_ALREADY_OPEN
                        or error_code == SomfyError.UNEXPECTED_ERROR
                    ):
                        if retry:
                        ...
                        error_code == SomfyError.WRONG_CREDENTIALS
                        or error_code == SomfyError.WRONG_CREDENTIALS_ALT
                    ):
                        ...
                        error_code == SomfyError.WRONG_CODE
                        or error_code == SomfyError.WRONG_CODE_ALT
                    ):
